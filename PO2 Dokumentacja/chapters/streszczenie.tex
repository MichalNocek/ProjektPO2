...
Praca opisuje aplikację \emph{TestPortal} - program do tworzenia i przeprowadzania testów oraz
...
This document describes the \emph{TestPortal} application - an information system for creating,
