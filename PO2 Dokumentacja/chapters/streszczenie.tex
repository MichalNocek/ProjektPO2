...
Dokument ten opisuje aplikację \emph{Testownik} - system informatyczny służący do tworzenia,
udostępniania i przeprowadzania testów oraz do zarządzania wynikami uczniów. Głównym celem
projektu było dostarczenie nauczycielowi narzędzia, które automatyzuje cały cykl pracy z testem:
od ułożenia pytań, przez przypisanie testu grupom uczniów, aż po automatyczne i ręczne ocenianie
odpowiedzi oraz analizę statystyczną wyników.
...
visibility, cheating detection, exporting results to a CSV file and password hashing.
