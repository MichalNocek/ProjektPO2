...
\titlePL{Testownik - aplikacja do zarządzania testami i ocenami}
\titleEN{Testownik - a test and grade management application}

\shorttitlePL{Testownik}
\shorttitleEN{Testownik}
...
% Rozdziały
%------------------------------------------------------------------------------
\include{chapters/streszczenie}     % 1
\include{chapters/wprowadzenie}     % 2
\include{chapters/wymagania}        % 3
\include{chapters/architektura}     % 4
\include{chapters/technologie}      % 5
\include{chapters/baza}             % 6
\include{chapters/implementacja}    % 7
\include{chapters/prezentacja}      % 8
\include{chapters/harmonogram}      % 9
\include{chapters/uruchomienie}     % 10
\include{chapters/podsumowanie}     % 11
